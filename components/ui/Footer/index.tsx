    ...
    <div className="w-full   py-6">
      <div className="flex flex-col md:flex-row justify-between px-4 md:px-6 py-6 mx-auto w-[calc(98vw)] md:w-[calc(100vw-18rem)] lg:max-w-6xl gap-4">
        <div className="w-full md:w-3/12 flex flex-col gap-8">
          ...
          <Image
            src={`/${process.env.NEXT_PUBLIC_SITE_NAME}/gaming-curacao.png`}
            width={180}
            height={69}
            alt="Gaming Curacao"
          />
        ...
        <div className="flex-1 flex gap-2 md:gap-4">
          <div className="w-full">
            <h3 className="text-lg text-white font-bold uppercase mb-2">
              Jogos
            </h3>
              ...
              {process.env.NEXT_PUBLIC_FOOTER_INSTAGRAM && (
                <li className="w-10 h-10">
                  <Link
                    ...
                    className="w-10 h-10 flex items-center justify-center text-sm  rounded-ful"
                  >
                    <svg
      ...
      <div className="text-center text-xs text-zinc-400 py-10 px-4 md:px-6 border-t border-zinc-600 mx-auto  w-[calc(98vw)] md:w-[calc(100vw-18rem)] lg:max-w-6xl">
        <p className="mb-4">
          {process.env.NEXT_PUBLIC_SITE_NAME} é um site de apostas esportivas e
          cassino online, que oferece aos seus usuários uma experiência única de
          apostas em diversos esportes, incluindo futebol, basquete, tênis,
          vôlei, entre outros. Com uma plataforma intuitiva e fácil de usar,{" "}
          {process.env.NEXT_PUBLIC_SITE_NAME} permite que seus usuários apostem
          em jogos ao vivo, além de oferecer uma ampla variedade de opções de
          apostas pré-jogo.
        </p>
        <p className="mb-4">
          Com o objetivo de proporcionar a melhor experiência de apostas aos
          seus usuários, {process.env.NEXT_PUBLIC_SITE_NAME} oferece uma ampla
          gama de recursos e ferramentas, incluindo estatísticas detalhadas dos
          jogos, histórico de resultados, análises de especialistas e muito
          mais. Além disso, o site oferece diversas promoções e bônus exclusivos
          para seus usuários, aumentando as chances de lucro e proporcionando
          uma experiência ainda mais emocionante.
        </p>
        <p className="mb-4">
          {process.env.NEXT_PUBLIC_SITE_NAME} é uma plataforma segura e
          confiável, que oferece suporte ao cliente 24 horas por dia, sete dias
          por semana. Com uma equipe de especialistas em apostas esportivas e
          cassino online, {process.env.NEXT_PUBLIC_SITE_NAME} está comprometida
          em garantir que seus usuários tenham uma experiência positiva e
          segura, e possam desfrutar de todas as emoções e oportunidades
          oferecidas pelas apostas esportivas de forma responsável e consciente.
        </p>
      </div>
      ...
      <div className="text-center text-xs text-zinc-400 py-5 px-4 md:px-6 border-t border-zinc-600 mx-auto  w-[calc(98vw)] md:w-[calc(100vw-18rem)] lg:max-w-6xl">
        Este site oferece jogos com experiência de risco. Para ser um usuário do
        nosso site, você deve ter mais de 18 anos.
        <br />
        Não somos responsáveis pela violação de suas leis locais relacionadas ao
        i-gambling.
      </div>
      ...
      <div className="flex justify-between text-xs text-zinc-400 py-5 px-4 md:px-6 border-t border-zinc-600 mx-auto  w-[calc(98vw)] md:w-[calc(100vw-18rem)] lg:max-w-6xl">
        <div>
          © {process.env.NEXT_PUBLIC_SITE_NAME} | {new Date().getFullYear()} -
