...
} from "@/contexts/TransactionContext/types"
...
export default function Transaction() {
  ...
  return (
    <div className="rounded border border-white/10 bg-[#0d0716] p-6">
      <h2 className="text-white text-lg font-bold mb-4 uppercase">
        Minhas Transações
      </h2>
          ...
          <>
              ...
              <table className=" w-full text-sm text-left text-gray-400">
                ...
                <tbody className="divide-y divide-zinc-600">
                  {transactions.data.map((transaction, index) => (
                    <tr
                      key={index}
                      className="hover:bg-zinc-800 odd:bg-zinc-800/20"
                    >
                      <th
                        scope="row"
                      ...
                      >
                        {transaction.type == "debit" ? (
                          <div className="bg-red-500 text-white flex items-center justify-center rounded w-5 h-5">
                            <ArrowDownIcon className="h-4 w-4" />
                          </div>
                        ) : (
                          <div className="bg-[#30A46C] text-white flex items-center justify-center rounded w-5 h-5">
                      ...
                      <td className="px-6 py-2">{transaction.created_at}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <div className="flex items-center justify-between flex-wrap gap-2 gap-y-1 mt-3">
              <div className="text-sm">
                Exibindo {transactions.meta.from} a {transactions.meta.to} de{" "}
                {transactions.meta.total} registros
              </div>
