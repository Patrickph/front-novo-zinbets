        ...
        <div className="rounded w-full border border-white/10 bg-[#0d0716] p-6 flex flex-col">
          ...
          <div className="flex-1 flex flex-col gap-2 justify-between">
            <div className="font-bold text-4xl">
              <div className="text-base font-normal">Reais</div>
              {formatBRL(wallet?.balance ?? 0.0)}
            </div>
        ...
        {wallet && wallet?.bonus > 0 && (
          <div className="rounded w-full bg-zinc-700 p-6">
            <div className="flex justify-between mb-2">
              <h2 className="text-white text-lg font-bold uppercase">Bônus</h2>
            ...
            <div className="space-y-1">
              ...
              <div className="text-zinc-400">
                ...
                <div className="text-sm">Regras do bônus</div>
              </div>
              ...
              <div className="pt-2">
                <div className="mb-1 flex items-center justify-between text-sm">
                  ...
                  <div className="text-xs text-center">
                    {formatBRL((bonus?.rollover?.amount ?? 0) / 100)} /{" "}
                    {formatBRL(
                      ((bonus?.credit_hold ?? 0) *
                ...
                <div className="pt-2">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <div className="text-xs text-center">
                      {bonus?.rollover?.count} /{" "}
                      {bonus?.rollover?.rollover_count}
                    </div>
